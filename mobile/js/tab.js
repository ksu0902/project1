...
$(document).ready(function(){
  ...
  $('.tabs .tab1').css('color','#fff').css('backgroundColor','#0090C2');
           //첫번째 탭 활성화
  ...
  $('.tabs .tab').each(function (index) {  //index=0,1,2,...
    $(this).click(function(){ //각각의 탭메뉴를 클릭하면   
	  ...
	  for(var i=1;i<=cnt;i++){  //1,2,3
       $('.tab'+i).css('opacity','.7').css('color','#333').css('backgroundColor','#ddd');
      }  //모든 탭메뉴를 비활성화~~
      $(this).css('backgroundColor','#0090C2').css('opacity','1').css('color','#fff'); //클릭한 해당 탭메뉴만 활성화
   });
  });
