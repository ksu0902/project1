  ...
  <div id="content">
	<div id="col2">        
		...
		<div id="list_search">
			...
			<div id="list_search5"><button class="submitbtn">검색하기</button></div>
		</div>
		</form>
		
		<select name="scale" onchange="location.href='list.php?scale='+this.value" class="listselect">
                    <option value=''>보기</option>
                    <option value='1'>10개씩 보기</option>
                    <option value='2'>15개씩 보기</option>
                    <option value='3'>20개씩 보기</option>
                    <option value='4'>30개씩 보기</option>
        </select>    
		...
		<div id="list_top_title">
			<ul>
				...
				<li id="list_title2">image</li>
				<li id="list_title3">subject</li>
...
?>			
			&nbsp;&nbsp;&nbsp;&nbsp; next &rsaquo;
				...
				<div id="button">
					<a href="list.php?table=<?=$table?>&page=<?=$page?>"><button class="listreturn">목록</button></a>&nbsp;
<? 
	if($userid)
	{
?>
		<a href="write_form.php?table=<?=$table?>"><button class="writebtn">글쓰기</button></a>
<?
	}
?>
				</div>
